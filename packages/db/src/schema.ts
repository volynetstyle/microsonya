...
export const summaryRuns = pgTable(
  "summary_runs",
  {
    ...
    classifierPolicyVersion: text("classifier_policy_version"),
    summaryPromptVersion: text("summary_prompt_version"),
    summaryPlanSchemaVersion: text("summary_plan_schema_version"),
    classifierEvidence: jsonb("classifier_evidence"),
    classifierAction: text("classifier_action"),
    planValidationStatus: text("plan_validation_status"),
    planRetryCount: integer("plan_retry_count"),
    ...
    realizerLatencyMs: integer("realizer_latency_ms"),
