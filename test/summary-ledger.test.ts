  ...
  it("atomically stores encrypted immutable evidence and a review candidate", async () => {
    ...
    try {
      ...
      expect(run).toMatchObject({
        ...
        contextCount: 1,
        buildSha: "build-abc",
        classifierPolicyVersion: "classifier-v0.1",
        summaryPromptVersion: "summary-v2",
        summaryPlanSchemaVersion: "summary-plan-v0.1",
        classifierAction: "SUMMARIZE",
        planValidationStatus: "valid",
        planRetryCount: 1,
        planHash: "plan-sha256",
        streamMode: "progressive",
        plannerLatencyMs: 12,
        realizerLatencyMs: 18,
...
function fixtureAttempt(): SummaryRunAttempt {
  ...
  return {
    ...
    summaryPromptVersion: "summary-v2",
    summaryPlanSchemaVersion: "summary-plan-v0.1",
    classifierEvidence: { durable: true, compressionUseful: true },
    classifierAction: "SUMMARIZE",
    planValidationStatus: "valid",
    planRetryCount: 1,
    planHash: "plan-sha256",
