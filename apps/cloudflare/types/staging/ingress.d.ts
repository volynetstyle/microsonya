...
interface __BaseEnv_Env {
  ...
  SUMMARY_RUNS: Service<
    typeof import("../../src/lifecycle/worker").SummaryRunsEntrypoint
  >;
  SUMMARY_PROCESSOR: Service<
    typeof import("../../src/processor/worker").SummaryProcessorEntrypoint
  >;
}
