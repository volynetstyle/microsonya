/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/ingress/wrangler.staging.jsonc --config=workers/lifecycle/wrangler.staging.jsonc --config=workers/processor/wrangler.staging.jsonc types/staging/ingress.d.ts` (hash: de5bc13a54bd8f7375b6af6118034147)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	ANALYTICS: AnalyticsEngineDataset;
	SUMMARY_JOBS: Queue;
	BOT_USERNAME: "microsonya_bot";
	TELEGRAM_WEBHOOK_SECRET: string;
	TELEGRAM_BOT_TOKEN: string;
	MICROSONYA_DATA_ENCRYPTION_KEY: string;
	SUMMARY_RUNS: Service<typeof import("../../src/lifecycle/worker").SummaryRunsEntrypoint>;
	SUMMARY_PROCESSOR: Service<typeof import("../../src/processor/worker").SummaryProcessorEntrypoint>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../src/ingress/worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_USERNAME" | "TELEGRAM_WEBHOOK_SECRET" | "TELEGRAM_BOT_TOKEN" | "MICROSONYA_DATA_ENCRYPTION_KEY">> {}
}
