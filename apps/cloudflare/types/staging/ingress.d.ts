/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/ingress/wrangler.staging.jsonc --config=workers/lifecycle/wrangler.staging.jsonc --config=workers/processor/wrangler.staging.jsonc types/staging/ingress.d.ts` (hash: 38e82cf2ac1bec9ae0bb040854da5390)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	ANALYTICS: AnalyticsEngineDataset;
	SUMMARY_JOBS: Queue;
	BOT_USERNAME: "MicrosonyaStagingBot";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_USERNAME" | "TELEGRAM_WEBHOOK_SECRET" | "MICROSONYA_DATA_ENCRYPTION_KEY">> {}
}
