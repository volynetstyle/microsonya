/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/lifecycle/wrangler.staging.jsonc types/staging/lifecycle.d.ts` (hash: 987f2d213f40a410319a317bb2299924)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../src/lifecycle/worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MICROSONYA_DATA_ENCRYPTION_KEY">> {}
}
