/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/processor/wrangler.staging.jsonc --config=workers/lifecycle/wrangler.staging.jsonc types/staging/processor.d.ts` (hash: f012514c0647796013826ba59b5fcd19)
