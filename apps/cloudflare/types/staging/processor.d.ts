/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/processor/wrangler.staging.jsonc --config=workers/lifecycle/wrangler.staging.jsonc types/staging/processor.d.ts` (hash: 8dca7a072b33589fd55633a838946c5e)
