/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/processor/wrangler.staging.jsonc --config=workers/lifecycle/wrangler.staging.jsonc types/staging/processor.d.ts` (hash: fe7fcb59a76be02f78b4921dbdd13089)
