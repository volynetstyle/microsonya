/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/processor/wrangler.staging.jsonc --config=workers/lifecycle/wrangler.staging.jsonc types/staging/processor.d.ts` (hash: 304a8315477741eca2818054b01653e6)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	ANALYTICS: AnalyticsEngineDataset;
	PROCESSOR_VERSION: "0.1.1-staging";
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../src/processor/worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROCESSOR_VERSION" | "OLLAMA_BASE_URL" | "MICROSONYA_DATA_ENCRYPTION_KEY" | "OLLAMA_API_KEY" | "TELEGRAM_BOT_TOKEN">> {}
}
