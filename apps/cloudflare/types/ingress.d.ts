/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/ingress/wrangler.jsonc --config=workers/lifecycle/wrangler.jsonc --config=workers/processor/wrangler.jsonc types/ingress.d.ts` (hash: fb38f81b7d4cc6f24d22791ca2896b71)
