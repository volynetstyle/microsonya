/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/ingress/wrangler.jsonc --config=workers/lifecycle/wrangler.jsonc --config=workers/processor/wrangler.jsonc types/ingress.d.ts` (hash: 71bb3de677608ca0e12baa85ede7b0a5)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	ANALYTICS: AnalyticsEngineDataset;
	SUMMARY_JOBS: Queue;
	BOT_USERNAME: "MicrosonyaBot";
