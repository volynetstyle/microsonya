/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/processor/wrangler.jsonc --config=workers/lifecycle/wrangler.jsonc types/processor.d.ts` (hash: 4b0300889542dbf570c5465db5246596)
