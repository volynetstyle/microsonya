/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/processor/wrangler.jsonc --config=workers/lifecycle/wrangler.jsonc types/processor.d.ts` (hash: 7975848a937feda13559652aa7a201cf)
