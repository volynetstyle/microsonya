/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../summary-runs/wrangler.jsonc --config=../summary-processor/wrangler.jsonc` (hash: 9a3d860951b15e055c2e311bb910b6e4)
...
interface __BaseEnv_Env {
	...
	SUMMARY_RUNS: Service<typeof import("../summary-runs/src/worker").SummaryRunsEntrypoint>;
	SUMMARY_PROCESSOR: Service<typeof import("../summary-processor/src/worker").SummaryProcessorEntrypoint>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_USERNAME" | "TELEGRAM_WEBHOOK_SECRET">> {}
}
